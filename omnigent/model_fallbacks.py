...
_RLM_QUERY_DEFAULT = StaticModelFallback(
    model_ids=("gpt-5.4",),
    owner="RLM query tool (omnigent.tools.builtins.rlm_query)",
    provenance="fork RLM tool default when the agent spec omits tools.builtins.model",
    discovery_gap="rlm_query runs before a session catalog is reachable",
)
RLM_QUERY_DEFAULT_MODEL = _RLM_QUERY_DEFAULT.model_ids[0]

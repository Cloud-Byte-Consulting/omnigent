...
def mint_session_token(
    ...
    :param groups: The subject's groups (e.g. Entra group OIDs), carried so
        later requests can resolve them for the OPA admin carve-out. Omitted
        from the token when empty to keep it small and preserve the prior
        shape.
...
def mint_session_cookie(
    ...
    :returns: An HS256-signed JWT string.
    """
    return mint_session_token(user_id, cookie_secret, ttl_hours * 3600, provider, groups=groups)
